...
<template>
  <div v-if="movieStore.currentMovie">
    <div
      class="details-backdrop"
      :style="{
        backgroundImage: `url(https://image.tmdb.org/t/p/w1280${movieStore.currentMovie.backdrop_path})`,
      }"
    >
        ...
        <div class="details">
          ...
          <div class="info">
            <p>
              ...
              {{ formatBudget(movieStore.currentMovie.budget) }}
            </p>
            <p>
              <strong>Avaliação:</strong>
              {{ formatVote(movieStore.currentMovie.vote_average) }}
            </p>
          </div>
        </div>
      </div>
